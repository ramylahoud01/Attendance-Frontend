...
const RecognitionBreakInDialog = ({ open, onClose }) => {
    ...
    const captureFrame = async () => {
        if (videoRef.current && !isProcessingRef.current) {
            ...
            try {
                const response = await BreakInEmployee(imageData, false);
...
export default RecognitionBreakInDialog;
