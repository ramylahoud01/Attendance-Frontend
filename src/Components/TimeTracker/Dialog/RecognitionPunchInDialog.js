...
const RecognitionPunchInDialog = ({ open, onClose }) => {
    ...
    const captureFrame = async () => {
        if (videoRef.current && !isProcessingRef.current) {
            ...
            try {
                const response = await PunchInEmployee(imageData, false);
...
export default RecognitionPunchInDialog;
