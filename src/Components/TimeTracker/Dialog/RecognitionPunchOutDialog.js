...
const RecognitionPunchOutDialog = ({ open, onClose }) => {
    ...
    const captureFrame = async () => {
        if (videoRef.current && !isProcessingRef.current) {
            ...
            try {
                const response = await PunchOutEmployee(imageData, false);
...
export default RecognitionPunchOutDialog;
